defmodule ElixirSplitwiseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirSplitwiseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirSplitwiseWeb.Gettext, "errors", msg, opts)
    end
  end
